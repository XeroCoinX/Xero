Xero Core version 0.9.4 is now available from:

  https://xero.org/bin/0.9.4/
...
this update is incompatible with the Xero system and could lead to consensus
forks.

Xero Core released binaries from https://xero.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~xero/+archive/ubuntu/xero
- A third-party or self-compiled Xero Core

upgrade to Xero Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
