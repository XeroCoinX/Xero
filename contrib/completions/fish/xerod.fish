...
complete --command xerod --no-files

# Extract options
function __fish_xerod_get_options
...
complete \
    --command xerod \
    --arguments "(__fish_xerod_get_options --nofiles)"
