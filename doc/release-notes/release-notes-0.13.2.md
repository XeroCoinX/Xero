Xero Core version 0.13.2 is now available from:

  <https://xero.org/bin/xero-core-0.13.2/>
...
- #8908 `4a974b2` Update xero-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow xero-tx to create v2 transactions (xrodrak)
