...
class TxnMallTest(XeroTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 XRO:
        ...
        # First: use raw transaction API to send 1240 XRO to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 XRO coin each
        ...
        # Node0's balance should be starting balance, plus 50XRO for another
        ...
        # Node0's total balance should be starting balance, plus 100XRO for
