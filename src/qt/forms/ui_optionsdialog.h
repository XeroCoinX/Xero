...
public:
    ...
    QPushButton *openXeroConfButton;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        xeroAtStartup = new QCheckBox(tabMain);
        xeroAtStartup->setObjectName(QString::fromUtf8("xeroAtStartup"));

        verticalLayout_Main->addWidget(xeroAtStartup);
        ...
        embeddedFont_label_1->setText(QString::fromUtf8("111.11111111 XRO"));
        ...
        embeddedFont_label_9->setText(QString::fromUtf8("909.09090909 XRO"));
        ...
        systemFont_label_1->setText(QString::fromUtf8("111.11111111 XRO"));
        ...
        systemFont_label_9->setText(QString::fromUtf8("909.09090909 XRO"));
        ...
        openXeroConfButton = new QPushButton(OptionsDialog);
        openXeroConfButton->setObjectName(QString::fromUtf8("openXeroConfButton"));
        openXeroConfButton->setAutoDefault(false);

        verticalLayout_Buttons->addWidget(openXeroConfButton);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        xeroAtStartup->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically start %1 after logging in to the system.", nullptr));
#endif // QT_CONFIG(tooltip)
        xeroAtStartup->setText(QCoreApplication::translate("OptionsDialog", "&Start %1 on system login", nullptr));
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        mapPortUpnp->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically open the Xero client port on the router. This only works when your router supports UPnP and it is enabled.", nullptr));
#endif // QT_CONFIG(tooltip)
        mapPortUpnp->setText(QCoreApplication::translate("OptionsDialog", "Map port using &UPnP", nullptr));
#if QT_CONFIG(tooltip)
        mapPortNatpmp->setToolTip(QCoreApplication::translate("OptionsDialog", "Automatically open the Xero client port on the router. This only works when your router supports NAT-PMP and it is enabled. The external port could be random.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocks->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the Xero network through a SOCKS5 proxy.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        connectSocksTor->setToolTip(QCoreApplication::translate("OptionsDialog", "Connect to the Xero network through a separate SOCKS5 proxy for Tor onion services.", nullptr));
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        openXeroConfButton->setToolTip(QCoreApplication::translate("OptionsDialog", "Open the %1 configuration file from the working directory.", nullptr));
#endif // QT_CONFIG(tooltip)
        openXeroConfButton->setText(QCoreApplication::translate("OptionsDialog", "Open Configuration File", nullptr));
#if QT_CONFIG(tooltip)
