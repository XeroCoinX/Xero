...
This document provides guidelines for internationalization of the Xero Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `xero_en.ts` remains unchanged.
