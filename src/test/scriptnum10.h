...
#ifndef XERO_TEST_SCRIPTNUM10_H
#define XERO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Xero Core 0.10.0, for cross-comparison.
 */
public:
