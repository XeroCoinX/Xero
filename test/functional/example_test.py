...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the XeroTestFramework
    pass


class ExampleTest(XeroTestFramework):
    # Each functional test is a subclass of the XeroTestFramework class.
    ...
    def custom_method(self):
        ...
        XeroTestFramework class so other tests can use it."""
