Download URL: https://sourceforge.net/projects/xero/files/Xero/xero-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 XRO fee schedule (users still pay 0.01 XRO per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #xero00 - #xero99
