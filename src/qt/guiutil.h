...
#ifndef XERO_QT_GUIUTIL_H
#define XERO_QT_GUIUTIL_H
...
/** Utility functions used by the Xero Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "xero:" URI into recipient object, return true on successful parsing
