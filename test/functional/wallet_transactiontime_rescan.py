...
class TransactionTimeRescanTest(XeroTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine XRO and create transactions
        ...
        # generate some xro to create transactions and check blockcount
        ...
        # send 10 xro to user's first watch-only address
        self.log.info('Send 10 xro to user')
        ...
        # send 5 xro to our second watch-only address
        self.log.info('Send 5 xro to user')
        ...
        # send 1 xro to our third watch-only address
        self.log.info('Send 1 xro to user')
