...
AC_DEFUN([XERO_QT_CONFIGURE],[
  ...
  dnl the final binary as well. _XERO_QT_CHECK_STATIC_PLUGIN does
  ...
  if test "$xero_cv_static_qt" = "yes"; then
    ...
    if test "$TARGET_OS" != "android"; then
      _XERO_QT_CHECK_STATIC_PLUGIN([QMinimalIntegrationPlugin], [-lqminimal])
    ...
    if test "$TARGET_OS" = "windows"; then
      ...
      _XERO_QT_CHECK_STATIC_PLUGIN([QWindowsIntegrationPlugin], [-lqwindows])
      _XERO_QT_CHECK_STATIC_PLUGIN([QWindowsVistaStylePlugin], [-lqwindowsvistastyle])
      AC_DEFINE([QT_QPA_PLATFORM_WINDOWS], [1], [Define this symbol if the qt platform is windows])
    elif test "$TARGET_OS" = "linux"; then
      _XERO_QT_CHECK_STATIC_PLUGIN([QXcbIntegrationPlugin], [-lqxcb])
      ...
      _XERO_QT_CHECK_STATIC_PLUGIN([QCocoaIntegrationPlugin], [-lqcocoa])
      _XERO_QT_CHECK_STATIC_PLUGIN([QMacStylePlugin], [-lqmacstyle])
...
dnl
dnl _XERO_QT_IS_STATIC
dnl ---------------------
dnl
dnl Requires: INCLUDES and LIBS must be populated as necessary.
dnl Output: xero_cv_static_qt=yes|no
AC_DEFUN([_XERO_QT_IS_STATIC],[
...
dnl
dnl _XERO_QT_CHECK_STATIC_PLUGIN(PLUGIN, LIBRARIES)
dnl --------------------------------------------------
dnl
dnl Requires: INCLUDES and LIBS must be populated as necessary.
...
AC_DEFUN([_XERO_QT_CHECK_STATIC_PLUGIN], [
...
dnl
dnl _XERO_QT_CHECK_STATIC_LIBS
dnl -----------------------------
dnl
dnl Outputs: QT_LIBS is prepended.
AC_DEFUN([_XERO_QT_CHECK_STATIC_LIBS], [
...
dnl
dnl _XERO_QT_FIND_LIBS
dnl ---------------------
dnl
dnl Outputs: All necessary QT_* variables are set.
dnl Outputs: have_qt_test and have_qt_dbus are set (if applicable) to yes|no.
AC_DEFUN([_XERO_QT_FIND_LIBS],[
  XERO_QT_CHECK([
