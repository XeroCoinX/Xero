...
#ifndef XERO_CRYPTO_CHACHA_POLY_AEAD_H
#define XERO_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@xero.
 *
 ...
 *
 * The chacha20-poly1305@xero combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@xero cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@xero are relatively fast in
...
#endif // XERO_CRYPTO_CHACHA_POLY_AEAD_H
