...
public:
    ...
    void setupUi(QDialog *ReceiveCoinsDialog)
    {
        ...
        reqAmount = new XeroAmountField(frame2);
...
#if QT_CONFIG(tooltip)
        label_3->setToolTip(QCoreApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the Xero network.", nullptr));
#endif // QT_CONFIG(tooltip)
