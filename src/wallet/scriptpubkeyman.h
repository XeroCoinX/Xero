...
#ifndef XERO_WALLET_SCRIPTPUBKEYMAN_H
#define XERO_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Xero Core wallet was originally a collection of unrelated private
...
#endif // XERO_WALLET_SCRIPTPUBKEYMAN_H
