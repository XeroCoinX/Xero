...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/xero/xero/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(XeroTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our xerod node")
