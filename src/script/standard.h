...
#ifndef XERO_SCRIPT_STANDARD_H
#define XERO_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a xero address
 */
...
/**
 * Generate a Xero scriptPubKey for the given CTxDestination. Returns a P2PKH
