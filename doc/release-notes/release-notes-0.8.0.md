Xero-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/xero/files/Xero/xero-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Xero
...
New/changed settings (command-line or xero.conf file)
--------------------------------------------------------
