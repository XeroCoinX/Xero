...
{
    // Test regression https://github.com/xero/xero/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/xero-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/xero-core/gui/pull/568.
    // With fListen=false in ~/.config/Xero/Xero-Qt.conf and all else left as default,
    // xero-qt should set both -listen and -listenonion to false and start successfully.
