...
QT_MOC_LITERAL(6, 52, 22), // "wallet::AddressPurpose"
QT_MOC_LITERAL(7, 75, 7), // "purpose"
QT_MOC_LITERAL(8, 83, 6) // "status"

    },
    "AddressTableModel\0updateEntry\0\0address\0"
    "label\0isMine\0wallet::AddressPurpose\0"
    "purpose\0status"
};
...
void AddressTableModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->updateEntry((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< bool(*)>(_a[3])),(*reinterpret_cast< wallet::AddressPurpose(*)>(_a[4])),(*reinterpret_cast< int(*)>(_a[5]))); break;
        default: ;
        }
    }
}
