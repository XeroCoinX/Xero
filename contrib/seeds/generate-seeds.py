...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef XERO_CHAINPARAMSSEEDS_H\n')
    g.write('#define XERO_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the xero network\n')
    ...
    g.write('#endif // XERO_CHAINPARAMSSEEDS_H\n')
