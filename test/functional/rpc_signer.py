...
Verify that a xerod node can use an external signer command.
...
class RPCSignerTest(XeroTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart xerod with -signer=<cmd>',
