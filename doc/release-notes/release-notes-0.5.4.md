Xero version 0.5.4 is now available for download at:
http://sourceforge.net/projects/xero/files/Xero/xero-0.5.4/
...
http://gitorious.org/xero/xerod-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Xero-Qt notifications under Growl 1.3.
Increase required age of Xero-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxXero properly when installing Xero-Qt over it. (Windows)
