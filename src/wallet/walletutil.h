...
#ifndef XERO_WALLET_WALLETUTIL_H
#define XERO_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! xero from opening the wallet, thinking it was newly created, and
...
#endif // XERO_WALLET_WALLETUTIL_H
