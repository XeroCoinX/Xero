...
class TestShell:
    """Wrapper Class for XeroTestFramework.

    The TestShell class extends the XeroTestFramework
    ...
    class __TestShell(XeroTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by XeroTestFramework child class.
            self.num_nodes = 1
