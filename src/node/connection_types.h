...
#ifndef XERO_NODE_CONNECTION_TYPES_H
#define XERO_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/xero-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Xero’s Peer-to-Peer Network")
...
#endif // XERO_NODE_CONNECTION_TYPES_H
