...
#ifndef XERO_INTERFACES_NODE_H
#define XERO_INTERFACES_NODE_H
...
//! Top-level interface for a xero node (xerod process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or xero.conf.
