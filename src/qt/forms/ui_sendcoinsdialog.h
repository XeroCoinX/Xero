...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QString::fromUtf8("0.00 XRO"));
        ...
        labelCoinControlFee->setText(QString::fromUtf8("0.00 XRO"));
        ...
        labelCoinControlAfterFee->setText(QString::fromUtf8("0.00 XRO"));
        ...
        labelCoinControlChange->setText(QString::fromUtf8("0.00 XRO"));
        ...
        customFee = new XeroAmountField(frameFeeSelection);
        ...
        labelBalance->setText(QString::fromUtf8("123.456 XRO"));
...
#if QT_CONFIG(tooltip)
        labelCustomFeeWarning->setToolTip(QCoreApplication::translate("SendCoinsDialog", "When there is less transaction volume than space in the blocks, miners as well as relaying nodes may enforce a minimum fee. Paying only this minimum fee is just fine, but be aware that this can result in a never confirming transaction once there is more demand for xero transactions than the network can process.", nullptr));
#endif // QT_CONFIG(tooltip)
