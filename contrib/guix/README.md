# Bootstrappable Xero Core Builds

This directory contains the files necessary to perform bootstrappable Xero
Core builds.
...
To build Xero Core reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/xero-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/xero-core/guix.sigs).
