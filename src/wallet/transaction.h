...
#ifndef XERO_WALLET_TRANSACTION_H
#define XERO_WALLET_TRANSACTION_H
...
public:
     ...
     * on this xero node, and set to 0 for transactions that were created
...
#endif // XERO_WALLET_TRANSACTION_H
