...
#ifndef XERO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define XERO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // XERO_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
