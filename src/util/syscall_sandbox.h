...
#ifndef XERO_UTIL_SYSCALL_SANDBOX_H
#define XERO_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during xerod initialization if Xero Core was compiled
...
#endif // XERO_UTIL_SYSCALL_SANDBOX_H
