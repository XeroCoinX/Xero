...
"""Verify that starting xero with -h works as expected."""

from test_framework.test_framework import XeroTestFramework
from test_framework.util import assert_equal

class HelpTest(XeroTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xero with -h for help text")
        ...
        self.log.info("Start xero with -version for version information")
        ...
        self.log.info("Start xerod with -fakearg to make sure it does not start")
