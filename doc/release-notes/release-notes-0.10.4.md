Xero Core version 0.10.4 is now available from:

  <https://xero.org/bin/xero-core-0.10.4/>
...
- #6953 `43c2789` Split xero-tx into its own package
- #6953 `dfe0d4d` Include xero-tx binary on Debian/Ubuntu
