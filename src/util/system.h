 ...
 */
#ifndef XERO_UTIL_SYSTEM_H
#define XERO_UTIL_SYSTEM_H
...
extern const char * const XERO_CONF_FILENAME;
extern const char * const XERO_SETTINGS_FILENAME;
