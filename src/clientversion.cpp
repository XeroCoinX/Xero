 ...
 * for both xerod and xero-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("XeroCoin");
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/xero/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (copyright_devs.find("Bitcoin Core") == std::string::npos) {
        ...
        strYear.replace(strYear.find("2025"), sizeof("2025")-1, "2009-2025");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/XeroCoinX/Xero>";
