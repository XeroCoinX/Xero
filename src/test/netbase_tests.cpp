...
{
    BOOST_CHECK(TestSplitHost("www.xerocore.org", "www.xerocore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.xerocore.org]", "www.xerocore.org", 0));
    BOOST_CHECK(TestSplitHost("www.xerocore.org:80", "www.xerocore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.xerocore.org]:80", "www.xerocore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:25170", "127.0.0.1", 25170));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:25170", "127.0.0.1", 25170));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:25170", "::ffff:127.0.0.1", 25170));
    BOOST_CHECK(TestSplitHost("[::]:25170", "::", 25170));
    BOOST_CHECK(TestSplitHost("::25170", "::25170", 0));
    BOOST_CHECK(TestSplitHost(":25170", "", 25170));
    BOOST_CHECK(TestSplitHost("[]:25170", "", 25170));
    ...
    BOOST_CHECK(TestSplitHost("www.xerocore.org:65536", "www.xerocore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.xerocore.org:0", "www.xerocore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.xerocore.org:", "www.xerocore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:25170", "127.0.0.1:25170"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:25170", "[::]:25170"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
