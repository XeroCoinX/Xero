...
class NetTest(XeroTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=25170)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 25170)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=25170), {"success": False})
