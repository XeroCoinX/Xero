...
"""Example logging Xero Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/xerod
...
def main(xerod_path):
    ...
    b = BPF(text=program, usdt_contexts=[xerod_with_usdts])
