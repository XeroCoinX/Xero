...
//! Entry point for XeroApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &XeroApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for XeroGUI tests.
void AppTests::guiTests(XeroGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &XeroGUI::consoleShown, this, &AppTests::consoleTests);
