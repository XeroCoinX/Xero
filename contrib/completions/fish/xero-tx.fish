...
# Extract options
function __fish_xero_tx_get_options
...
# Extract commands
function __fish_xero_tx_get_commands
...
complete \
    --command xero-tx \
    --condition "not __fish_xero_seen_cmd (__fish_xero_tx_get_commands --commandsonly)" \
    --arguments "(__fish_xero_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command xero-tx \
    --arguments "(__fish_xero_tx_get_commands)" \
    --no-files
