Xero Core version 0.9.2.1 is now available from:

  https://xero.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 XRO to 0.01 XRO
...
- Fix "Start xero on system login"
