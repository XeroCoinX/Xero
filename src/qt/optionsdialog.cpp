      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->xeroAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->xeroAtStartup);
    ...
    ui->xeroAtStartup->setToolTip(ui->xeroAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->xeroAtStartup->setText(ui->xeroAtStartup->text().arg(PACKAGE_NAME));

    ui->openXeroConfButton->setToolTip(ui->openXeroConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new XeroUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->xeroAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSXROontrols);
...
void OptionsDialog::on_openXeroConfButton_clicked()
{
