...
By default, xerod will dump mempool on shutdown and
...
class MempoolPersistTest(XeroTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent xerod from writing mempool.dat to disk. Verify that `savemempool` fails")
